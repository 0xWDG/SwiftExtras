//
//  PlainBorderedToggleStyle.swift
//  SwiftExtras
//
...
///
/// The style uses a ``GrayButtonStyle`` button style and a border around the
/// toggle.
///
/// Example:
/// ```swift
...
@available(iOS 17.0, macOS 14.0, tvOS 17.0, watchOS 10.0, *)
public extension ToggleStyle where Self == PlainBorderedToggleStyle {
    /// A toggle style that uses a border around the toggle.
    ///
    /// Example:
    /// ```swift
    ...
    ///     .toggleStyle(.plainBordered)
    /// ```
    static var plainBordered: PlainBorderedToggleStyle { .init() }
}
