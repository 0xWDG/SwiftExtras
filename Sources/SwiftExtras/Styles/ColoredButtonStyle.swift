...
/// The text color is white when the button is enabled and blue when the button
/// is disabled.
///
...
public extension ButtonStyle where Self == ColoredButtonStyle {
    ...
    /// The text color is white when the button is enabled and the custom color
    ...
    /// The text color is white when the button is enabled and red when the
    /// button is disabled.
    ///
    ...
    ///
    /// The style uses the system's orange color for the background of the
    /// button.
    /// The text color is white when the button is enabled and orange when the
    /// button is disabled.
    ///
    ...
    ///
    /// The style uses the system's yellow color for the background of the
    /// button.
    /// The text color is white when the button is enabled and yellow when the
    /// button is disabled.
    ///
    ...
    ///
    /// The style uses the system's green color for the background of the
    /// button.
    /// The text color is white when the button is enabled and green when the
    /// button is disabled.
    ///
    ...
    /// The text color is white when the button is enabled and mint when the
    /// button is disabled.
    ///
    ...
    /// The text color is white when the button is enabled and teal when the
    /// button is disabled.
    ///
    ...
    /// The text color is white when the button is enabled and cyan when the
    /// button is disabled.
    ///
    ...
    ///
    /// The style uses the system's blue color for the background of the button.
    /// The text color is white when the button is enabled and blue when the
    /// button is disabled.
    ///
    /// - Returns: A button style that uses the system's blue color.
    ///
    ...
    /// The text color is white when the button is enabled and indigo when the
    /// button is disabled.
    ///
    ...
    ///
    /// The style uses the system's purple color for the background of the
    /// button.
    /// The text color is white when the button is enabled and purple when the
    /// button is disabled.
    ///
    ...
    /// The text color is white when the button is enabled and pink when the
    /// button is disabled.
    ///
    ...
    ///
    /// The style uses the system's brown color for the background of the
    /// button.
    /// The text color is white when the button is enabled and brown when the
    /// button is disabled.
    ///
    ...
    ///
    /// The style uses the system's white color for the background of the
    /// button.
    /// The text color is white when the button is enabled and white when the
    /// button is disabled.
    ///
    ...
    /// The text color is white when the button is enabled and gray when the
    /// button is disabled.
    ///
    ...
    ///
    /// The style uses the system's black color for the background of the
    /// button.
    /// The text color is white when the button is enabled and black when the
    /// button is disabled.
    ///
    ...
    ///
    /// The style uses the system's primary color for the background of the
    /// button.
    /// The text color is white when the button is enabled and primary when the
    /// button is disabled.
    ///
    ...
    ///
    /// The style uses the system's secondary color for the background of the
    /// button.
    /// The text color is white when the button is enabled and secondary when
