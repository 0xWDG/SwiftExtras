...
/// allowing for a single implementation to be used for both UIKit and AppKit
/// platforms.
public protocol PlatformViewRepresentable: PlatformViewRepresentableType {
    ...
    ///
    /// This is equivalent to `makeUIView` on UIKit platforms and `makeNSView`
    /// on AppKit platforms.
    ...
    ///
    /// This is equivalent to `updateUIView` on UIKit platforms and
    /// `updateNSView` on AppKit platforms.
...
public extension PlatformViewRepresentable
    where UIViewType == PlatformViewType {
    /// Create the platform view.
    ///
    /// - Parameter context: SwiftUI context.
    /// - Returns: The new instance of your platform view.
...
#else
public extension PlatformViewRepresentable
    where NSViewType == PlatformViewType {
    /// Create the platform view.
    ///
    /// - Parameter context: SwiftUI context.
    /// - Returns: The new instance of your platform view.
