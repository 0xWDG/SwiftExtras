...
/// `UIViewControllerRepresentable/NSViewControllerRepresentable` alias for
/// platform-agnostic code.
public typealias PlatformViewControllerRepresentable =
...
public extension NSImage {
    ...
    func pngData() -> Data? {
        ...
        return NSBitmapImageRep(data: tiffRepresentation)?.representation(
            using: .png,
            properties: [:]
        )
    }
