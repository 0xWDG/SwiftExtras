...
//
    ...
    (canImport(AppKit) || canImport(UIKit)) && !canImport(Colors)
import SwiftUI
...
public extension Color {
    ...
    /// The color for borders or divider lines that hides any underlying
    /// content.
    ...
    /// A green color that automatically adapts to the current trait
    /// environment.
    ...
    /// A purple color that automatically adapts to the current trait
    /// environment.
    ...
    /// A yellow color that automatically adapts to the current trait
    /// environment.
