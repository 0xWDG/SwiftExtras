...
public extension Notification.Name {
    /// Returns the publisher of the notification on the default notification
    /// center.
    ///
    /// This property provides a convenient way to access a publisher for the
    /// notification
    ...
    ///   - center: The notification center on which to post the notification.
    /// Defaults to `.default`.
    ///
    /// - Example:
    ///   ```swift
    ...
    ///   ```
    func post(object: Any? = nil, on center: NotificationCenter = .default) {
